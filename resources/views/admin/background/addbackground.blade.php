            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  ...
                  <form action="{{route('createbackground')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="status" name="status"  placeholder="กรอกข้อมูล">
                        <div class="row mt-3">
                            @error('status')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
